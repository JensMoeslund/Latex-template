...
\vspace*{\fill}
    ...
    angle=0,
    opacity=1.0,  %% adjust
    contents={\includegraphics[width=\paperwidth,height=\paperheight]{chapters/00Frontmatter/figures/aau_waves}}
    }
...
%% Comment this section in if you are doing Bachelor or Master Project   
  ...
  \vfill
  \begin{center}
    \includegraphics[width=0.2\paperwidth]{chapters/00Frontmatter/figures/aau_logo_circle_en}% comment this line in for English version
